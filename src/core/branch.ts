                ...
                case 'E':
                    if (BBCVs > 4) {
                        ...
                        if (BBCVs > 0) {
                            ...
                            return 'H';
                        } else if (speed !== Sp.slow && CL === 1 && DD === 4) {
                            return 'H';
                        } else {
                            return 'D';
                        }
                        ...
                        if (Ds === 5) {
                            ...
                            return 'H';
                        } else if (speed !== Sp.slow && CL === 1 && DD === 3) {
                            return 'H';
                        } else {
                            return [
                                { node: 'D', rate: 0.6 },
        ...
        case '3-2':
            switch (node) {
                ...
                case 'C':
                    ...
                    } else if (speed === Sp.slow || radar === 0 || CL + DD + AO < 6) {
                        return 'G';
                    } else if (speed === Sp.fastest && radar > 3) {
                        return 'E';
        ...
        case '4-3':
            switch (node) {
                ...
                case '1': // nullがヤな感じ 多分こういうことだろうという
                    if (CVH > 0) {
                        return 'C';
                    } else if (Ds > 3 && (speed !== Sp.slow || BBs + CVL === 0)) {
                        return 'D';
                    } else if (Ds > 2 && CL > 0) {
                        return 'D';
                ...
                case 'F':
                    if (Ss > 0 || DD === 0 || CVs === 0) {
                        return 'K';
                    } else if (speed !== Sp.slow && BBCVs < 3 && DD > 1) {
                        return 'H';
                    } else {
                        return [
                            { node: 'H', rate: 0.3 },
        ...
        case '4-5':
            switch (node) {
                ...
                case 'R':
                    if (isFaster) {
                        return 'N';
                    } else if (speed !== Sp.slow && CL + CAV > 0 && DD > 1) {
                        return 'N';
                    } else {
                        return 'S';
                    }
        ...
        case '5-3':
            switch (node) {
                ...
                case '1':
                    if (isFaster) {
                        return 'D';
                    } else if (BBCVs > 2 || (BBCVs === 2 && speed === Sp.slow)) {
                        return 'C';
                    } else if (Ss > 0) {
                        return [
                            { node: 'C', rate: 0.4 },
                ...
                switch (node) {
                    ...
                    case 'C':
                        if (BBCVs > 0 || Ds === 0) {
                            ...
                            } else if (speed !== Sp.slow && CA === 1 && CL === 1 && DD === 3) {
                                return 'I';
                            } else {
                                return 'D';
                            }
            ...
            switch (node) {
                case null:
                    switch (option.phase) {
                        ...
                        case '7':
                            if (!isUnion) {
                                return '1';
                            } else if (f_type === Ft.surface && BBs > 3) {
                                return '1';
                ...
                case 'O':
                    if (Number(option.phase) < 4) {
                        return 'P';
                    } else if (f_type === Ft.carrier || f_type === Ft.surface) {
                        return 'P';
                    } else { // f_type === Ft.f4 // 通常艦隊がくるかは分からない
                        return 'R';
                    }
                    break;
                case 'Q':
            ...
            switch (node) {
                ...
                case 'B':
                    if (Number(option.phase) < 3) {
                        return 'C';
                    } else if (CL > 0 && DD > 2 && speed === Sp.fast) {
                        return 'W';
                    } else {
                        return 'C';
                    }
                ...
                case 'K':
                    ...
                    break;
                case 'R':
                    if (BBs < 3 && CL + AV > 0 && DD > 1 && speed !== Sp.slow) {
                        return 'R2';
                    } else {
                        return 'R1';
                    }
                ...
                case 'R2':
                    if (DD > 4) {
                        return 'T';
                    } else if (CL > 0 && DD > 3 && speed !== Sp.slow) {
                        return 'T';
                    } else {
                        return 'S';
                    }
            ...
            switch (node) {
                ...
                case '1':
                    if (Number(option.phase) < 2 && Ss > 0) {
                        ...
                        return 'A';
                    } else if (yamato > 1 && speed === Sp.slow) {
                        return 'A';
                ...
                case 'D':
                    if (BB > 0) {
                        ...
                        return 'D1';
                    } else if (CVL === 0 && BBV === 0 && CLE > 1 && speed === Sp.slow) {
                        return 'D1';
                ...
                case 'U':
                    if (BBs < 4 && CVH === 0 && CVL < 2 && CL > 1 && Ds > 3) {
                        return 'V';
                    } else if (yamato < 2 && CVH < 2 && DD > 3 && speed !== Sp.slow) {
                        return 'V';
                    } else if (yamato < 2 && CL > 1 && speed !== Sp.slow) {
                        return 'V';
                    } else {
                        return 'J2';
                    }
        ...
        case '59-1':
            switch (node) {
                ...
                case 'C1':
                    ...
                    break;
                case 'C2':
                    if (BBs < 2 && CVH === 0 && CVL < 2 && Ds > 1 && speed !== Sp.slow) {
                        return 'L';
                    } else {
                        return 'C1';
                    }
            ...
            switch (node) {
                ...
                case 'I':
                    if (CVH > 1) {
                        ...
                        return 'J';
                    } else if (CLE < 2 && speed === Sp.slow) {
                        return 'J';
                    } else if (Ds + LHA < 6 && speed === Sp.slow) {
                        return 'J';
                    } else if (BBs < 2) {
                        return 'L';
                    } else if (countAktmrPlusCVs(fleet) < 2) {
            ...
            switch (node) {
                case null:
                    if (!isUnion && f_length !== 7) {
                        ...
                        return '1';
                    } else if (option.phase === '1' && (f_type === Ft.surface || f_type === Ft.carrier)) {
                        return '1';
                    } else if (Number(option.phase) > 1 && (f_type === Ft.surface || f_type === Ft.carrier)) {
                        return '3';
                    }
                    break;
                case '1':
                ...
                case 'P':
                    if (track.includes('1')) {
                        ...
                        if (yamato > 1) {
                            ...
                            return 'T';
                        } else if (f_type === Ft.surface && speed === Sp.slow) {
                            return 'T';
                        } else {
                            return 'U';
                        }
                ...
                case 'Q':
                    ...
                    break;
                case 'V':
                    if (LHA > 0 && speed === Sp.slow) {
                        return 'V1';
                    } else if (AV > 1 && speed === Sp.slow) {
                        return 'V1';
            ...
            switch (node) {
                ...
                case 'E':
                    if (isFaster) {
                        ...
                        return 'G';
                    } else if (Ds > 4 && CA > 1 && CVH === 0 && CVL < 2 && speed !== Sp.slow) {
                        return 'G';
                    } else {
                        return 'F';
                    }
            ...
            switch (node) {
                ...
                case '2':
                    if (f_type === Ft.transport) {
                        ...
                        return 'L';
                    } else if (CL > 1 && Ds > 2 && speed !== Sp.slow) {
                        return 'L';
                    } else {
                        return 'H';
                    }
                ...
                case 'P':
                    if (f_type === Ft.transport) {
                        return 'R';
                    } else if (BB + CVH === 0 && BBV + CVL < 2 && speed !== Sp.slow) {
                        return 'R';
                    } else {
                        return 'F';
                    }
        ...
        case '60-4':
            switch (node) {
                ...
                case 'T':
                    if (isFaster) {
                        return 'U';
                    } else if (Ds > 5 && BBs + CVH < 3 && speed !== Sp.slow) {
                        return 'U';
                    } else {
                        return 'C';
                    }
            ...
            switch (node) {
                ...
                case '1':
                    if (AO + LHA + AV + AS > 2) {
                        ...
                        return 'A';
                    } else if (CVH === 0 && BBs + CVL > 2 && speed === Sp.slow) {
                        return 'A';
                    } else {
                        return 'C';
                    }
                ...
                case 'E':
                    if (BBCVs > 3) {
                        return 'E1';
                    } else if (BBs + CVH > 2 && speed === Sp.slow) {
                        return 'E1';
                    } else if (Ds < 2) {
                        return 'E1';
                    } else if (Ss > 0) {
