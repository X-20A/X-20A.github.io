...
export const calc_58_4: CalcFnWithCondition = (
    ...
    switch (node) {
        ...
        case 'D':
            ...
            return 'D2';
        case 'E':
            if (count_Yamato_class(fleet) === 2 && DD <= 4) {
                return 'F';
            }
            if (count_Yamato_class(fleet) === 1 && DD <= 3) {
                return 'F';
            }
            if (count_Yamato_class(fleet) === 0 && DD <= 2) {
                return 'F';
            }
            if (BBCVs <= 4) {
                return 'F1';
