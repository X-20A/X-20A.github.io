                ...
                switch (node) {
                    ...
                    case 'L':
                        if (fleet.isFaster()) {
                            ...
                            return 'N';
                        } else if ((seek[1] < 60 && seek[1] >= 56) || BBs + CV + CVB > 4) {
                            return [
                                { node: 'N', rate: 0.5 },
                                { node: 'P', rate: 0.5 },
                            ];
                ...
                switch (node) {
                    ...
                    case '1':
                        if (Number(option.phase) < 2 && Ss > 0) {
                            ...
                            return 'A';
                        } else if (fleet.countYamatoClass() > 1 && speed === '低速艦隊') {
                            return 'A';
                    ...
                    case 'D':
                        if (BB > 0) {
                            ...
                            return 'D1';
                        } else if (CVL === 0 && BBV === 0 && CL + CT > 1 && speed === '低速艦隊') {
                            return 'D1';
                    ...
                    case 'U':
                        if (BBs < 4 && CV + CVB === 0 && CVL < 2 && CL > 1 && Ds > 3) {
                            return 'V';
                        } else if (fleet.countYamatoClass() < 2 && CV + CVB < 2 && DD > 3 && speed !== '低速艦隊') {
                            return 'V';
                        } else if (fleet.countYamatoClass() < 2 && CL > 1 && speed !== '低速艦隊') {
                            return 'V';
                        } else {
                            return 'J2';
                        }
            ...
            case '59-1':
                switch (node) {
                    ...
                    case 'C1':
                        ...
                        break;
                    case 'C2':
                        if (BBs < 2 && CV + CVB === 0 && CVL < 2 && Ds > 1 && speed !== '低速艦隊') {
                            return 'L';
                        } else {
                            return 'C1';
                        }
                ...
                switch (node) {
                    ...
                    case 'E':
                        if (fleet.isFaster()) {
                            ...
                            return 'G';
                        } else if (Ds > 4 && CA > 1 && CV + CVB === 0 && CVL < 2 && speed !== '低速艦隊') {
                            return 'G';
                        } else {
                            return 'F';
                        }
            ...
            case '60-2':
                switch(node) {
                    ...
                    case 'H':
                        if (track.includes('1')) {
                            return 'I';
                        } else if (option.difficulty === '4' && fleet.countDaigo() > 4) {
                            return 'L';
                    ...
                    case 'P':
                        if (f_type === '輸送護衛部隊') {
                            return 'R';
                        } else if (BB + CV + CVB === 0 && BBV + CVL < 2 && speed !== '低速艦隊') {
                            return 'R';
                        } else {
                            return 'F';
                        }
                ...
                switch (node) {
                    ...
                    case 'D':
                        if (CVs > 0) {
                            ...
                            return 'D3';
                        } else if (option.difficulty === '2' && fleet.countDaigo() > 2) {
                            return 'D3';
                        } else if (option.difficulty === '1') {
                            return 'D3';
                        } else {
