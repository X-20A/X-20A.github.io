/**
 * 改修1段階分のネジ数 [必要ネジ, 確実化ネジ]。
 * 未判明の値は null、確実化ネジの記載自体が無い装備は要素が1つだけ。
 */
export type ImprovementStep = (number | null)[];

export type ImprovableItem = {
    id: number;
    name: string;
    canImprovement: true;
    step1: ImprovementStep;
    step2: ImprovementStep;
    step3: ImprovementStep;
};

export type UnimprovableItem = {
    id: number;
    name: string;
    canImprovement: false;
};

export type ImprovementItem = ImprovableItem | UnimprovableItem;

export const imp_json: ImprovementItem[] = [
    {
        "id": 1,
        "name": "12cm単装砲",
        "canImprovement": true,
    ...
    {
        "id": 360,
        "name": "Bofors 15cm連装速射砲 Mk.9Model 1938",
        "canImprovement": false
    },
    {
        "id": 361,
