	...
	<div>
		...
		<div class="side-bar-container" ref="sideBarRef">
			<span class="header-side-close" @pointerdown="closeSidebar">
				<SvgIcon name="menu" color="#ffffff" class="side-bar-icon"></SvgIcon>
			</span>
			<div class="side-menu">
				<a href="/compass">
					<p class="side-menu-content">羅針盤シミュ</p>
				</a>
				<a href="/reference">
					<p class="side-menu-content">資料室</p>
				</a>
				<a href="/terminal">
				...
				<a href="/akashi">
					<p class="side-menu-content">改修効率計算機</p>
				</a>
				<a href="/dock">
					<p class="side-menu-content">入渠計算機</p>
				</a>
				<a href="/suzu">
					<p class="side-menu-content">涼月タイマー</p>
				</a>
			</div>
		</div>
